#!/usr/bin/env python3
"""
Prepare Apple code-signing for Remoot using only an App Store Connect API key.
...
APP_NAME = env("APP_NAME", "Remoot")
PROFILE_NAME = env("PROFILE_NAME", "Remoot App Store")
